...
// function CurvedArrow({ positions, color, flowDirection }) {
//     const map = useMap();
//     useEffect(() => {
...
//             dashOffset = flowDirection === 'forward' ? (dashOffset + 1) % 30 : (dashOffset - 1) % 30;
...
//         };
//     }, [positions, color, flowDirection, map]);
//     return null;
// }
...
//             const levelsResp = await fetch('/api/Data?start_date=0&end_date=2000000000');
...
//                     const flowDirection = 'forward';
//                     return (
//                         <React.Fragment key={idx}>
//                             <CurvedArrow positions={[fromPos, toPos]} color={color} flowDirection={flowDirection} />
